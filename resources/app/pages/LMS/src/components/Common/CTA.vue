<template>
  ...
  >
    <div
      class="bg-[#f0eedf] dark:bg-[#0a0e19] rounded-[25px] py-[70px] md:py-[30px] px-[20px] md:px-[30px] lg:px-[60px] xl:px-[110px] relative z-[1]"
    >
      <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-[25px]">
        <div class="text-center ltr:md:text-left rtl:md:text-right">
          <h2
            class="!text-xl md:!text-3xl lg:!text-4xl xl:!text-5xl md:-tracking-[1px] !mb-[20px] md:!mb-[25px] xl:!mb-[40px] !text-gray-800 dark:!text-gray-100"
          >
        ...
        <div class="ltr:text-right rtl:text-left">
          <img
            src="@/assets/images/lms-courses/learning.png"
            class="inline-block"
            alt="learning-image"
          />
        </div>
      ...
      <div
        class="absolute -z-[1] ltr:right-[30px] rtl:left-[30px] top-[50px] hidden md:block"
      >
        <img src="@/assets/images/lms-courses/shapes/shape3.png" alt="shape3" />
      </div>
      <div
        class="absolute -z-[1] ltr:right-[43%] rtl:left-[43%] bottom-[90px] hidden md:block"
      >
        <img src="@/assets/images/lms-courses/shapes/shape4.png" alt="shape4" />
      </div>
    </div>
  </div>
</template>
