<template>
  <div
    :class="[
      'saas-navbar fixed top-0 right-0 left-0 transition-all h-auto z-[5] py-[20px] md:py-[30px] lg:py-[40px] xl:py-[60px]',
      className,
      { 'is-sticky': isSticky },
    ]"
    id="navbar"
  >
    <div
      class="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1345px] 2xl:max-w-[1705px] mx-auto px-[12px]"
    >
      <div
        class="inner-navbar bg-white dark:bg-dark rounded-[15px] py-[15px] md:py-[18px] px-[15px] md:px-[25px] lg:px-[30px] transition-all"
      >
        <div
