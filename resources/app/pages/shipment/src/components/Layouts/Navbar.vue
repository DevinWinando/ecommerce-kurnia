<template>
  <div
    :class="[
      'shipment-navbar bg-white dark:bg-dark fixed top-0 right-0 left-0 transition-all h-auto z-[5] py-[20px] md:py-[30px]',
      className,
      { 'is-sticky': isSticky },
    ]"
    id="navbar"
  >
    <div
      class="container sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1644px] mx-auto px-[12px]"
    >
      <div
      ...
      >
        ...
        <div class="hidden lg:flex items-center grow basis-full basis-auto">
          <ul class="flex mx-auto flex-row gap-[30px] xl:gap-[40px]">
            <li v-for="(item, index) in navItems" :key="index">
              <template v-if="item.isExternal">
                <a
                  :href="item.path"
                  class="font-medium transition-all hover:text-[#E36925]"
                  target="_blank"
              ...
              <template v-else>
                <RouterLink
                  ...
                  class="font-medium transition-all hover:text-[#E36925]"
                  :class="{
                    'text-[#E36925]': isActive(item.path),
                    '': !isActive(item.path),
                  }"
                >
                  {{ item.name }}
          ...
          <div class="flex items-center gap-[30px]">
            <a
              ...
              target="_blank"
              class="text-[#E36925] transition-all hover:underline font-medium inline-block"
            >
              Login
            </a>
            <a
              href="https://trezo-twcss.envytheme.com/"
              class="inline-block font-medium md:text-base rounded-[7px] bg-[#E36925] text-white py-[10.5px] lg:py-[11.5px] px-[22px] md:px-[25px] transition-all hover:bg-[#275b96]"
              target="_blank"
            >
              Register
            </a>
        ...
        >
          ...
          <div class="flex items-center gap-[15px] md:gap-[30px] mt-[15px]">
            <a
              href="https://trezo-twcss.envytheme.com/"
              target="_blank"
              class="text-[#E36925] transition-all hover:underline font-medium inline-block"
